...
export class AuthorController {
    ...
    @Get(':id')
    async findOneById(@Param('id', ParseIntPipe) id: number): Promise<ResponseData<Author>> {
    ...
    @Delete(':id')
    async delete(@Param('id', ParseIntPipe) id: number): Promise<ResponseData<boolean>> {
